...
2. **What operation do you occasionally need performed there?**
   The specific one. "Restart the sync connector when it wedges" beats
   "maintenance and support".

3. **How do you handle it today?**
   Standing VPN, a shared credential, a support ticket asking the customer to
   do it, your own agent, a screen-share, or you simply do not do it. "We tell
   them to reboot it" is a real answer and a common one.

4. **Who should have final authority to allow it?**
...
Equally useful, and we mean it:

- your existing agent already does this;
- the overhead is not worth it for how often it happens;
- your customers would never install anything;
- the boundary is in the wrong place;
- you did not follow what the demo was showing you.
